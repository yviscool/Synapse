...
* AI 사이트 입력창에서 `Ctrl + ↑ / ↓` 를 누르면 개요에서 이전/다음 사용자 프롬프트를 빠르게 다시 채울 수 있고, `Esc` 로 현재 초안을 복원할 수 있습니다
...
![프롬프트 목록](../demo/prompt1.png)
![프롬프트 분류](../demo/prompt2.png)
![프롬프트 선택기](../demo/3.png)

### 프롬프트 선택기 주입 (AI 입력란)

![프롬프트 편집](../demo/prompt_content1.png)
![프롬프트 미리보기](../demo/prompt_content2.png)
![버전 기록](../demo/prompt_content3.png)

### 대화 수집 및 관리

![대화 목록](../demo/chat1.png)
![대화 상세](../demo/chat2.png)
![대화 렌더링](../demo/chat4.png)
![대화 내보내기](../demo/chat3.png)
...
![스니펫 에디터](../demo/tool1.png)
![스니펫 미리보기](../demo/tool2.png)
...
* **AI 사이트 입력란**에서 `Ctrl + ↑ / ↓` 를 누르면 개요의 이전/다음 프롬프트로 빠르게 전환할 수 있고, `Esc` 로 현재 초안을 복원할 수 있습니다
...
[Microsoft Edge Add-ons에서 설치](https://microsoftedge.microsoft.com/addons/detail/foicpmidihacnocjmdbkjanbjncckoaa)
