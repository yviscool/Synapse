...
* AI サイトの入力欄で `Ctrl + ↑ / ↓` を押すと、アウトラインから前後のユーザープロンプトをすばやく再入力できます。`Esc` で現在の下書きを復元できます
...
* **AIサイトの入力欄**で `Ctrl + ↑ / ↓` を押すと、アウトライン内の前後のプロンプトをすばやく切り替えられます。`Esc` で現在の下書きを復元できます
...
[Microsoft Edge Add-ons からインストール](https://microsoftedge.microsoft.com/addons/detail/foicpmidihacnocjmdbkjanbjncckoaa)
