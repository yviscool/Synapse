...
* 在 AI 输入框中按 `Ctrl + ↑ / ↓` 可从大纲快速回填上一条 / 下一条用户提问，按 `Esc` 恢复当前草稿
...
* 在 **AI 网站输入框** 按 `Ctrl + ↑ / ↓` 可快速切换上一条 / 下一条提问，按 `Esc` 恢复当前草稿
...
### Edge 商店下载
[点击前往 Edge 商店安装](https://microsoftedge.microsoft.com/addons/detail/foicpmidihacnocjmdbkjanbjncckoaa)
