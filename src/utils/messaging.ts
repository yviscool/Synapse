...
export const MSG = {
  ...
  PERFORM_SEARCH: 'APM/PERFORM_SEARCH',

  // Indexing
  REBUILD_INDEX: 'APM/REBUILD_INDEX',
  ADD_TO_INDEX: 'APM/ADD_TO_INDEX',
  UPDATE_IN_INDEX: 'APM/UPDATE_IN_INDEX',
  REMOVE_FROM_INDEX: 'APM/REMOVE_FROM_INDEX',
} as const
