export default {
  ...
  "sync": {
    ...
    "confirmation": {
      "enable": "即将跳转到 Google 进行授权，以允许 Synapse 在您的 Google Drive 中创建专属应用文件夹来存放备份数据。我们不会访问您的任何其他文件。",
      "disconnect": "确定要断开云同步吗？您的数据将保留在云端，但此设备将不再同步。",
  ...
  "data": {
    ...
    "backup": {
      "title": "云端时光机",
      "description": "这里会列出您最近在云端的10个备份版本。您可以随时恢复到任一版本。",
      "refresh": "刷新列表",
      "noHistory": "暂无云端备份记录。",
      "restore": "恢复",
      "download": "下载",
