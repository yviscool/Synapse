<template>
  ...
  >
    ...
    <div
      v-if="hint.visible"
      class="fixed bottom-full mb-2 w-max px-3 py-1.5 bg-gray-900/80 text-white text-xs rounded-md shadow-lg transition-opacity duration-200"
...
const hint = ref({ visible: false, text: '' });
