<template>
  ...
  <div
    ...
    :class="[
      ...
      'border border-gray-200/50 dark:border-white/30',
      isCollapsed
    ...
    <div
      :class="[
        ...
        isCollapsed
          ...
          : 'h-[60px] px-5 flex items-center justify-between border-b border-gray-200/50 dark:border-white/30 bg-gray-50/50 dark:bg-white/[0.02]'
      ]"
        ...
        <div class="px-4 py-3 flex-shrink-0">
          <div class="relative">
            ...
            <input
              ...
              class="w-full pl-10 pr-3 py-2 text-sm bg-gray-100/70 dark:bg-white/5 border dark:border-white/30 rounded-xl focus:bg-white dark:focus:bg-white/10 focus:border-blue-500/50 dark:focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all duration-200 text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-white/70"
            />
          </div>
        </div>
